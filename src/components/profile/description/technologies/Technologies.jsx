...
const Technologies = () => {
  return (
    <div className="mt-20">
      <h3 className="italic text-3xl w-fit px-2 border-t border-slate-50 rounded-t-lg font-medium bg-slate-50">APTITUDES</h3>
      <div className="flex flex-wrap justify-around items-center pt-9 bg-slate-50 rounded-b-xl rounded-tr-xl shadow-xl">
