const Description = () => {
    return(
        <div className="mb-36 w-4/6 pt-24 flex flex-col">
            <h2 className="italic text-3xl mb-12 font-semibold text-slate-200" data-aos="fade-right">ACERCA DE MI:</h2>
            <p className="text-xl tracking-normal leading-relaxed text-slate-200" data-aos="fade-left">
